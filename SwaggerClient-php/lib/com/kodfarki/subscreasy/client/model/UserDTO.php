...
class UserDTO implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['password']) && (strlen($this->container['password']) > 100)) {
            $invalidProperties[] = "invalid value for 'password', the character length must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['password']) && (strlen($this->container['password']) < 4)) {
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (strlen($email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserDTO., must be smaller than or equal to 100.');
        }
        if (!is_null($email) && (strlen($email) < 5)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserDTO., must be bigger than or equal to 5.');
        }
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserDTO., must be smaller than or equal to 50.');
        }
        if (!is_null($first_name) && (strlen($first_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setImageUrl($image_url)
    {
        if (!is_null($image_url) && (strlen($image_url) > 256)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling UserDTO., must be smaller than or equal to 256.');
        }
        if (!is_null($image_url) && (strlen($image_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling UserDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setLangKey($lang_key)
    {
        if (!is_null($lang_key) && (strlen($lang_key) > 5)) {
            throw new \InvalidArgumentException('invalid length for $lang_key when calling UserDTO., must be smaller than or equal to 5.');
        }
        if (!is_null($lang_key) && (strlen($lang_key) < 2)) {
            throw new \InvalidArgumentException('invalid length for $lang_key when calling UserDTO., must be bigger than or equal to 2.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserDTO., must be smaller than or equal to 50.');
        }
        if (!is_null($last_name) && (strlen($last_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserDTO., must be bigger than or equal to 0.');
        }
    ...
    {
        if ((strlen($login) > 50)) {
            throw new \InvalidArgumentException('invalid length for $login when calling UserDTO., must be smaller than or equal to 50.');
        }
        if ((strlen($login) < 1)) {
            throw new \InvalidArgumentException('invalid length for $login when calling UserDTO., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[_'.@A-Za-z0-9-]*$/", $login))) {
            throw new \InvalidArgumentException("invalid value for $login when calling UserDTO., must conform to the pattern /^[_'.@A-Za-z0-9-]*$/.");
        }
    ...
    {
        if (!is_null($password) && (strlen($password) > 100)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserDTO., must be smaller than or equal to 100.');
        }
        if (!is_null($password) && (strlen($password) < 4)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserDTO., must be bigger than or equal to 4.');
        }
     ...
     * Sets reset_date
     *
     * @param string $reset_date reset_date
     *
     * @return $this
     */
    ...
    public function setSiteName($site_name)
    {
        if (!is_null($site_name) && (strlen($site_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $site_name when calling UserDTO., must be smaller than or equal to 50.');
        }
        if (!is_null($site_name) && (strlen($site_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $site_name when calling UserDTO., must be bigger than or equal to 1.');
        }
     ...
     * Sets subscriber
     *
     * @param bool $subscriber subscriber
     *
     * @return $this
     */
