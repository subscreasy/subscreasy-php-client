...
/**
 * RecurrencePeriod Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecurrencePeriod implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RecurrencePeriod';
    ...
    const RECURRENCE_TYPE_SECONDLY = 'SECONDLY';
    const RECURRENCE_TYPE_MINUTELY = 'MINUTELY';
    const RECURRENCE_TYPE_HOURLY = 'HOURLY';
    ...
    {
        return [
            self::RECURRENCE_TYPE_SECONDLY,
            self::RECURRENCE_TYPE_MINUTELY,
            self::RECURRENCE_TYPE_HOURLY,
            self::RECURRENCE_TYPE_DAILY,
            self::RECURRENCE_TYPE_WEEKLY,
            self::RECURRENCE_TYPE_MONTHLY,
            self::RECURRENCE_TYPE_YEARLY,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['recurrence_type'], $allowedValues)) {
    ...
    {
        $allowedValues = $this->getRecurrenceTypeAllowableValues();
        if (!in_array($recurrence_type, $allowedValues)) {
