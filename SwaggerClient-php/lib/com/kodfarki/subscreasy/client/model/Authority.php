...
class Authority implements ModelInterface, ArrayAccess
{
    ...
    {
        if ((strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Authority., must be smaller than or equal to 50.');
        }
        if ((strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Authority., must be bigger than or equal to 0.');
        }
